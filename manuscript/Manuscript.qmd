...
format:
  ...
  pdf:
    pdf-engine: xelatex
    number-sections: false #table of content,direct jump to sections
    margin-left: 0.8in
    margin-right: 0.8in
    margin-top: 0.8in
    margin-bottom: 0.8in
    toc: true
    keep-tex: true #tex file retained
    include-in-header:
      text: |
        \usepackage{lineno}
    include-before-body:
...
I am tying on this R markdown document for practise.
# Introduction
...
#| echo: false #if 'false' code not displayed in final document
...
/ #to add a new line. Visual mode you can add spaces
